...
#add the middle char to the end of the code

code += md5_2.hexdigest()[len(md5_2.hexdigest())//2]
...
if (DEBUG):
    ...
    print(f"disintuitive{code}")



# Writing the code to standard output 

#add disintuitive to the beginning to make copy and paste or piping quicker.

stdout.write(f"disintuitive{code}" + "\n")
