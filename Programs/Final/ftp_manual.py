...
Notes
================
- This program will pull a text message for file/directory
 permissions

 - First enter the IP value for the server 
 given by challenge/professor
 
 - Do the same for the port
 
 - Enter user and password to the server if necessary
  (MAY NEED TO OBTAIN THIS BY ANOTHER METHOD FIRST!!)
  (ACTUALLY WE PROBABLY WILL)

 - Method is the number of bits to break the binary output into
 (Done think this should be anything other than 7 or 8?? Right??)
'''
